...
if not result then result = metaLib.overflow("0x1677DF43", "note", newPass) // libHTTP 1.0.2
if not result then result = metaLib.overflow("0x1677DF43", "note", newPass) // libHTTP 1.0.3
